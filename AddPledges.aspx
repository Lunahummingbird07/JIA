<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddPledges.aspx.cs" Inherits="JIA.AddPledges" %>
					...
					<div class="panel-heading">Pledge Information</div>
					    <div class="panel-body">
						        <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <asp:Label ID="Label2"  runat="server" Text="Pledge">Pledge</asp:Label>

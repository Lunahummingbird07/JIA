...
namespace JIA
{
    public partial class PersonInfo : System.Web.UI.Page
    {
        ...
        protected void Button1_click(object sender, EventArgs e)
        {
            ...
            //string qry1 = "Select * from log_in";
            //SqlCommand cmd1 = new SqlCommand(qry1, con);
            //SqlDataAdapter viewbd1 = new SqlDataAdapter(cmd1);
            //DataTable vbd1 = new DataTable();
            //viewbd1.Fill(vbd1);
            ...
            //SqlCommand cmd = new SqlCommand(qry, con);
            //SqlDataAdapter viewdb = new SqlDataAdapter(cmd);

            //SqlDataReader vdb = cmd.ExecuteReader();
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            {
                Calendar Calendar1 = (Calendar)item.FindControl("Calendar1");
        ...
        protected void Button2_click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script language='javascript'>window.alert('Information incorrect Please Check ');window.location='PersonInfo.aspx';</script>");

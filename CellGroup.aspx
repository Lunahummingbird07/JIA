<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CellGroup.aspx.cs" Inherits="JIA.CellGroup" %>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Search Cell Group</div>
					<div class="panel-body">
						<div class="col-md-6">
							
								<div class="form-group">
									<label>Cell Group Code</label>
                                ...
                                <div class="form-group">
                                    <asp:Button ID="Button4" class="btn btn-primary" runat="server" Text="View Database" OnClick="Button4_click"/>
                                                ...
                                                <div class="form-group" style="width:800px;height:500px;overflow-x:scroll;overflow-y:scroll;" >
                                                    ...
                                                    <asp:DataList ID="cellgroupinfo" runat="server">
                                                         <HeaderTemplate>
                                                                <td></td>
                                                                <td> Cell Group No. </td>
                                                                <td>Cell Group Code</td>
                                                                <td>Cell Group Name</td>
                                                                <td>Cell Leader</td>
                                                                <td>Cell Facilitator</td>
                                                             </HeaderTemplate>
                                                    <itemtemplate>
                                                            <td>
                                                                <asp:Button ID="Button2" CommandArgument='<%# Eval("Cell_Group_Code") %>'  class="btn btn-primary" runat="server" Text="Edit" OnClick="Button2_Click" />
                                                                
                                                            </td>
                                                            <td >
                                                                <asp:Label ID="Label2" runat="server" Text='<%#Eval("Cell_Group_No") %>' ></asp:Label>
                                                            </td >
                                                             
                                                            <td >
                                                                <asp:Label ID="Label3" runat="server" Text='<%#Eval("Cell_Group_Code") %>' ></asp:Label>
                                                            </td>
                                                             
                                                            <td >
                                                                <asp:Label ID="Label4" runat="server" Text='<%#Eval("Cell_Group_Name") %>' ></asp:Label>    
                                                            </td>
                                                             
                                                            <td >
                                                                <asp:Label ID="Label5" runat="server" Text='<%#Eval("Cell_Leader") %>' ></asp:Label>
                                                            </td>
                                                             
                                                            <td >
                                                                <asp:Label ID="Label6" runat="server" Text='<%#Eval("Cell_Facilitator") %>' ></asp:Label>
                                                            </td>
					...
					<div class="panel-heading">Cell Group Information</div>
					    <div class="panel-body">
                            ...
                            <itemtemplate>
						        <div class="col-md-6"> 
								        <div class="form-group">
                                            <asp:Label ID="Label24"  runat="server" Text="Cell Group Code">Cell Group Code</asp:Label>
                                            <asp:TextBox ID="TextBox4" CssClass="form-control" Enabled="false"  Text='<%#Eval("Cell_Group_Code") %>' runat="server"></asp:TextBox>
								        </div>
                                    <div class="form-group">
                                            <asp:Label ID="Label22"  runat="server" Text="Cell Group Name">Cell Group Name</asp:Label>
                                            <asp:TextBox ID="TextBox7" CssClass="form-control"  Text='<%#Eval("Cell_Group_Name") %>' runat="server"></asp:TextBox>
								        </div>
                                    
						        </div>
								    <div class="col-md-6">
									    <div class="form-group">
                                            <asp:Label ID="Label26"  runat="server" Text="Cell Leader">Cell Leader</asp:Label>
                                            <asp:TextBox ID="TextBox9" CssClass="form-control"  Text='<%#Eval("Cell_Leader") %>' runat="server"></asp:TextBox>
								        </div>
                                    <div class="form-group">
                                            <asp:Label ID="Label27"  runat="server" Text="Cell Facilitator">Cell Facilitator</asp:Label>
                                            <asp:TextBox ID="TextBox10" CssClass="form-control"  Text='<%#Eval("Cell_Facilitator") %>' runat="server"></asp:TextBox>
								        </div>
                                        <asp:Button ID="Button3" runat="server" Text="Save" CssClass="btn btn-primary" CommandArgument='<%#Eval("Cell_Group_Code") %>'  OnClick="Button3_click"/>
								    </div>

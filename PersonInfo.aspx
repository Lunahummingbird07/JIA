<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonInfo.aspx.cs" Inherits="JIA.PersonInfo" %>
		...
		<div class="row">
			<div class="col-lg-12">
					...
					<div class="panel-body">
						<div class="col-md-6">
								...
								<asp:GridView ID="GridView1" Height="200" Width="600" runat="server" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"></asp:GridView>
                                                ...
                                                <div class="form-group" name="persondiv" id="persondiv" style="width:950px;height:500px;overflow-x:scroll;overflow-y:scroll;" >
                                                    ...
                                                    <itemtemplate>
                                                        <td>
                                                                <asp:Button ID="Button2" CommandArgument='<%#Eval("Person_ID") %>'  class="btn btn-primary" OnClick="Button3_Click" runat="server" Text="Edit"  />
				...
				<div class="panel panel-default">
                            ...
                            <div class="panel-body">
						        ...
						        <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="TextBox14" CssClass="form-control" Enabled="false"  Text='<%#Eval("Member_Since") %>' runat="server"></asp:TextBox>
                                            <asp:Button ID="Button4" runat="server" Text="View Calendar" class="btn btn-primary" OnClick="Button4_Click" />
                    ...
                    <div class="panel-body">
                            <asp:DataList ID="DataList2" runat="server" CssClass="table">
                            <itemtemplate>
						        <div class="col-md-6">
                                    <div class="form-group">
                    ...
                    <div class="panel-body">
                            <asp:DataList ID="DataList4" runat="server" CssClass="table">
                            <itemtemplate>
						        <div class="col-md-6">
                                    <div class="form-group">

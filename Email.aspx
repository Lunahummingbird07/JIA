<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Email.aspx.cs" Inherits="JIA.Email" %>
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-default">
					<div class="panel-heading">Email Information</div>
					    <div class="panel-body">
						        <div class="col-md-6">
								        <div class="form-group">
                                            <asp:Label ID="Label23" runat="server" Text="Sender's Name">From:</asp:Label>
                                            <asp:TextBox ID="TextBox3" CssClass="form-control" placeholder="Name of Sender"  runat="server"></asp:TextBox>
								        </div>

								        <div class="form-group">
                                            <asp:Label ID="Label24"  runat="server" Text="Last Name">Email</asp:Label>
                                            <asp:TextBox ID="TextBox4" CssClass="form-control" placeholder="Email of Sender"  runat="server"></asp:TextBox>
								            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Required"
                                                    ControlToValidate="TextBox4" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </div>

                                        <div class="form-group">
                                            <asp:Label ID="Label5"  runat="server" Text="Password">Password</asp:Label>
                                            <asp:TextBox ID="TextBox6" CssClass="form-control" placeholder="Password of Sender" TextMode="Password"  runat="server"></asp:TextBox>
								            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Required"
                                                    ControlToValidate="TextBox6" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </div>

                                        <div class="form-group">
                                            <asp:Label ID="Label3"  runat="server" Text="To:">To:</asp:Label>
                                            <asp:TextBox ID="TextBox2" CssClass="form-control" placeholder="Name of Reciever"  runat="server"></asp:TextBox>
								            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Required"
                                                    ControlToValidate="TextBox2" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </div>

                                        <div class="form-group">
                                            <asp:Label ID="Label4"  runat="server" Text="Email of Reciever">Email of Reciever</asp:Label>
                                            <asp:TextBox ID="TextBox5" CssClass="form-control" placeholder="Email of Reciever"  runat="server"></asp:TextBox>
								            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Required"
                                                    ControlToValidate="TextBox5" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </div>

                                        <div class="form-group">
                                            <asp:Label ID="Label6"  runat="server" Text="Subject">Subject</asp:Label>
                                            <asp:TextBox ID="TextBox7" CssClass="form-control" placeholder="Subject"  runat="server"></asp:TextBox>
								            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Required"
                                                    ControlToValidate="TextBox7" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </div>

                                        <div class="form-group">
                                            <asp:Label ID="Label2"  runat="server" Text="Body">Body</asp:Label>
                                    ...
                                    <asp:Button ID="Button3" CssClass="btn btn-primary" runat="server" Text="Send"   OnClick="Button2_click" />

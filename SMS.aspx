 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SMS.aspx.cs" Inherits="JIA.SMS" %>
					    ...
					    <div class="panel-body">
						        <div class="col-md-6">
								        <div class="form-group">
                                            <asp:Label ID="Label3" runat="server" Text="Sender's Name">Search Member's Name</asp:Label>
                                            <asp:TextBox ID="TextBox1" CssClass="form-control" placeholder="Sender Name"  runat="server"></asp:TextBox>
								            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Required"
                                                    ControlToValidate="txtSender" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </div>
                                    
                                    
                                        <div class="form-group">
                                            <asp:Label ID="Label23" runat="server" Text="Sender's Name">Sender's Name</asp:Label>
                                            <asp:TextBox ID="txtSender" CssClass="form-control" placeholder="Sender Name"  runat="server"></asp:TextBox>
								            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Required"
                                                    ControlToValidate="txtSender" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </div>

								        <%--<div class="form-group">
                                            <asp:Label ID="Label24"  runat="server" Text="Password">Password</asp:Label>
                                        ...
                                        <div class="form-group">
                                            <asp:Label ID="Label5"  runat="server" Text="Recepient Number:">Recepient Number:</asp:Label>
                                            <asp:TextBox ID="txtRecepientNumber" CssClass="form-control" placeholder="Recepient Number:"  runat="server"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            <asp:Label ID="Label2"  runat="server" Text="Body">Message</asp:Label>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchBirthday.aspx.cs" Inherits="JIA.SearchBirthday" %>
					...
					<div class="panel-body">
						<div class="col-md-6">
								...
								<div class="form-group">
									<label>Month</label>
                                    <asp:TextBox ID="TextBox1" CssClass="form-control" placeholder="Month" runat="server"></asp:TextBox>
								</div>
								<div class="form-group">

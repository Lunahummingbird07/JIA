<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSeminar.aspx.cs" Inherits="JIA.AddSeminar" %>
					    ...
					    <div class="panel-body">
						        <div class="col-md-6">
								        <div class="form-group">
                                            <asp:Label ID="Label23" runat="server" Text="Seminar Code">Seminar Code</asp:Label>
                                            <asp:TextBox ID="TextBox3" CssClass="form-control"  runat="server"></asp:TextBox>
								        </div>
								        <div class="form-group">
                                            <asp:Label ID="Label24"  runat="server" Text="Seminar Name">Seminar Name</asp:Label>
								    ...
								    <div class="col-md-6">
									    <div class="form-group">
										    <div class="form-group">
                                                    <asp:Label ID="Label20" runat="server" Text="Seminar Date">Seminar Date</asp:Label>
                                                    <asp:TextBox ID="TextBox5" CssClass="form-control"  runat="server"></asp:TextBox>
										    </div>
										    <div class="form-group">
                                                    <asp:Label ID="Label21"  runat="server" Text="Seminar Location">Seminar Location</asp:Label>

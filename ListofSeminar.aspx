<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListofSeminar.aspx.cs" Inherits="JIA.ListofSeminar" %>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Search Seminar</div>
					<div class="panel-body">
						<div class="col-md-6">
							
								<div class="form-group">
									<label>Seminar Code</label>
                                    <asp:TextBox ID="TextBox1" CssClass="form-control" placeholder="Cell Group Code" runat="server"></asp:TextBox>
								</div>
								<div class="form-group">
                                ...
                                <div class="form-group">
                                    <asp:Button ID="Button4" class="btn btn-primary" runat="server" Text="View Database" OnClick="Button4_click"/>
                                                ...
                                                <div class="form-group" style="width:1000px;height:300px;overflow-x:scroll;overflow-y:scroll;" >
                                                    ...
                                                    <asp:DataList ID="seminarinfo" runat="server" OnSelectedIndexChanged="seminarinfo_SelectedIndexChanged">
                                                         <HeaderTemplate>
                                                                <td></td>
                                                                <td> Seminar ID </td>
                                                                <td>Seminar Code</td>
                                                    ...
                                                    <itemtemplate>
                                                            <td>
                                                                <asp:Button ID="Button2" CommandArgument='<%# Eval("Seminar_Code") %>'  class="btn btn-primary" runat="server" Text="Edit" OnClick="Button2_Click" />
                                                                
                                                            </td>
                                                            <td >
                                                                <asp:Label ID="Label2" runat="server" Text='<%#Eval("Seminar_ID") %>' ></asp:Label>
                                                            </td >
                                                             
                                                            <td >
                                                                <asp:Label ID="Label3" runat="server" Text='<%#Eval("Seminar_Code") %>' ></asp:Label>
                                                            </td>
                                                             
                                                            <td >
                                                                <asp:Label ID="Label4" runat="server" Text='<%#Eval("Seminar_Name") %>' ></asp:Label>    
                                                            </td>
                                                             
                                                            <td >
                                                                <asp:Label ID="Label5" runat="server" Text='<%#Eval("Seminar_Date") %>' ></asp:Label>
                                                            </td>
                                                             
                                                            <td >
                                                                <asp:Label ID="Label6" runat="server" Text='<%#Eval("Seminar_Location") %>' ></asp:Label>
                                                            </td>
				...
				<div class="panel panel-default">
					<div class="panel-heading">Seminar Information</div>
					    <div class="panel-body">
                            <asp:DataList ID="editlist" runat="server" OnSelectedIndexChanged="editlist_SelectedIndexChanged" CssClass="table">
                            <itemtemplate>
						        <div class="col-md-6"> 
                                    <div class="form-group">
                                            <asp:Label ID="Label7"  runat="server" Text="Seminar_ID" Visible="false">Seminar ID</asp:Label>
                                            <asp:TextBox ID="TextBox2" CssClass="form-control" Visible="false"  Text='<%#Eval("Seminar_ID") %>' runat="server"></asp:TextBox>
								        </div>
								        <div class="form-group">
                                            <asp:Label ID="Label24"  runat="server" Text="Seminar Code">Seminar Code</asp:Label>
                                            <asp:TextBox ID="TextBox4" CssClass="form-control" Enabled="false"  Text='<%#Eval("Seminar_Code") %>' runat="server"></asp:TextBox>
								        </div>
                                    <div class="form-group">
                                            <asp:Label ID="Label22"  runat="server" Text="Seminar Name">Seminar Name</asp:Label>
                                            <asp:TextBox ID="TextBox7" CssClass="form-control"  Text='<%#Eval("Seminar_Name") %>' runat="server"></asp:TextBox>
								        </div>
                                    
						        </div>
								    <div class="col-md-6">
									    <div class="form-group">
                                            <asp:Label ID="Label26"  runat="server" Text="Seminar Date">Seminar Date</asp:Label>
                                            <asp:TextBox ID="TextBox9" CssClass="form-control"  Text='<%#Eval("Seminar_Date") %>' runat="server"></asp:TextBox>
								        </div>
                                    <div class="form-group">
                                            <asp:Label ID="Label27"  runat="server" Text="Seminar Location">Seminar Location</asp:Label>
                                            <asp:TextBox ID="TextBox10" CssClass="form-control"  Text='<%#Eval("Seminar_Location") %>' runat="server"></asp:TextBox>
								        </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchMemberSince.aspx.cs" Inherits="JIA.SearchMemberSince" %>
					...
					<div class="panel-heading">Search Cell Group</div>
                            ...
                            <div class="panel-body">
						        <div class="col-md-6">
                                    ...
                                    <asp:TextBox ID="TextBox1" CssClass="form-control" Enabled="false" placeholder="Date" runat="server"></asp:TextBox>
								    ...
								    <div class="col-md-6">
									    <div class="form-group">
                                             <div class="form-group">
                                              ...
                                              <asp:TextBox ID="TextBox2" CssClass="form-control" Enabled="false" placeholder="Date" runat="server"></asp:TextBox>

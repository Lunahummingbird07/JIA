<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainPage.aspx.cs" Inherits="JIA.MainPage1" %>
				...
				<ul class="nav navbar-top-links navbar-right">
					<li class="dropdown"><a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
						...
						<ul class="dropdown-menu dropdown-messages">
							<li>
								<div class="dropdown-messages-box"><a href="profile.aspx" class="pull-left">
...
<%--				<div class="profile-usertitle-name">Admin</div>--%>
		...
		<ul class="nav menu">
			<li class="active"><a href="MainPage.aspx"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a></li>
			...
			<li><a href="element.aspx"><em class="fa fa-toggle-off">&nbsp;</em> UI Elements</a></li>

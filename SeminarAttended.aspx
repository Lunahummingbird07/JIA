<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeminarAttended.aspx.cs" Inherits="JIA.SeminarAttended" %>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Seminar Attended by Each Person</div>
						...
						<div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <asp:Button ID="Button4" class="btn btn-primary" runat="server" Text="View Database" OnClick="Button4_click"/>
                                                ...
                                                <div class="form-group" style="width:1000px;height:450px;overflow-x:scroll;overflow-y:scroll;" >
